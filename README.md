...
1. **Защита от Race Condition (Gonka данных)**: используется пессимистичная блокировка строк базы данных (`SELECT ... FOR UPDATE`) на дефолтном уровне изоляции `READ COMMITTED`.
